...
import { Building, Construction, ArrowLeft } from 'lucide-react';
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center max-w-2xl">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Mülk yönetimi özelliği şu anda geliştirme aşamasında. MVP sürümünde bu özellik bulunmuyor, 
              ancak yakında eklenecek ve size daha iyi bir deneyim sunacak.
            </p>
            ...
            <div className="mt-12 bg-blue-50 border border-blue-200 rounded-lg p-6">
              ...
              <p className="text-blue-700 text-sm leading-relaxed">
                Bu özellik aktif olduğunda emlak portföyünüzü yönetebilecek, mülkleri listeleyebilecek, 
                detaylarını görüntüleyebilecek ve satış/kiralama süreçlerini takip edebileceksiniz.
              </p>
            </div>
          </div>
        </div>
